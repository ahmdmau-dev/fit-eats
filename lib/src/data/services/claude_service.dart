...
@LazySingleton(as: AIService, env: ['claude'])
class ClaudeService implements AIService {
  ClaudeService(this._dio);
...
''';
      ...
      final response = await _dio.post(
        ...
        data: {
          ...
          'system':
              'You are a professional nutritionist and meal planning expert. Generate balanced, healthy meal plans in JSON format.',
        },
      );

      // TODO: Parse Claude response and convert to MealPlan entity
      // For now, return not implemented
      return Left(
        Failure.notImplemented(
          message: 'Claude meal plan parsing not yet implemented',
        ),
      );
      ...
      return Left(
        Failure.unexpected(
          message: 'Unexpected error in Claude service: $e',
        ),
      );
    }
  }
...
''';
      ...
      final response = await _dio.post(
        ...
        data: {
          ...
          'system':
              'You are a professional fitness trainer and workout planning expert. Generate effective, safe workout plans in JSON format.',
        },
      );

      // TODO: Parse Claude response and convert to WorkoutPlan entity
      // For now, return not implemented
      return Left(
        Failure.notImplemented(
          message: 'Claude workout plan parsing not yet implemented',
        ),
      );
    } on DioException catch (e) {
      return Left(
